    ...
    <div class="container bg-red-100 mt-5">
        <div class="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-6 mr-5 ml-5">
            @foreach($posts as $post)
                <div class="bg-center @if($loop->first) md:col-span-2 lg:col-span-2 @endif" style="background-image: url('@if($post->images) {{$post->images->url}}  @endif'); height: 400px; weight:100%">
